...
import { API_ENDPOINTS_LOGIN, API_ENDPOINTS_LOGINPERSON, LOGIN_HEADER } from "../constants/api.constants";
import { post } from "./httpServices";

// aL INTENTAR HACER CON AXIOS, NO RECONOCE HEADER CONTENT-TYPE
export async function loginPersonService(username, password) { //hardcode
  try {
